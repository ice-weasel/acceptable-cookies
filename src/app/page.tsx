          ...
          <nav className="bg-transparent  fixed w-full z-20 top-0 left-0  ">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
              <a className="flex items-center">
                ...
                <span className="self-center text-2xl font-semibold whitespace-nowrap text-black">GoSafe</span>
              </a>
              <div className="flex md:order-2">

                <Link href={{ pathname: "/login" }} type="button" className="text-white bg-black  focus:ring-4 focus:outline-none focus:ring-black  font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0   
              ...
              <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-transparent rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent ">
                  <li>
                    <Link href={{ pathname: "/" }} className="block py-2 pl-3 pr-4 text-black text-l font-bold uppercase rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-gray-200 md:p-0 md:text-black ">Home</Link>
                  </li>
                  <li>
                    <Link href="#explore" className="block py-2 pl-3 pr-4 text-black text-l font-bold uppercase rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-gray-200 md:p-0 md:text-black ">Explore</Link>
                  </li>
        ...
        <div className='absolute inset-0 flex items-center justify-around text-white'>
          <div>
            ...
            <div className='mt-5 font-bold text-l'>
              <p>Wanna explore the vibrant beauty of India?
</p>
              <p>Explore Safely;
</p>
            ...
            <div className="mt-5 ">
              <Link href={{ pathname: "/signup" }} className="relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-white border-2 border-white rounded-full hover:text-black  group hover:bg-transparent">
